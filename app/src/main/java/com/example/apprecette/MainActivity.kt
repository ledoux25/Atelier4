...
import com.example.apprecette.data.Recipe
import com.example.apprecette.data.strawberryCake
import com.example.apprecette.ui.theme.AppRecetteTheme
import com.example.apprecette.ui.theme.Gray
import com.example.apprecette.ui.theme.LightGray
import com.example.apprecette.ui.theme.Shapes
import com.example.atelier2.ui.theme.AppBarCollapsedHeight
import com.example.atelier2.ui.theme.AppBarExpendedHeight
import com.example.apprecette.ui.theme.*
...
fun Reviews(recipe: Recipe){
    Row(
        ...
        Button(
            ...
            elevation = null,
            colors = ButtonDefaults.buttonColors(
                backgroundColor = com.example.apprecette.ui.theme.Transparent,
                contentColor = Pink
            )
            ) {
...
fun Image(){
    Row(){
        Row(
            ...
            horizontalArrangement = Arrangement.SpaceBetween ){
            Image(
                painter = painterResource(id = R.drawable.strawberry_pie_2), contentDescription =null,
                modifier = Modifier
                    .weight(1f)
            ...
            Image(
                painter = painterResource(id = R.drawable.strawberry_pie_3), contentDescription =null,
                modifier = Modifier
                    .weight(1f)
                    .clip(RoundedCornerShape(20))
            )
...
@Composable
fun IngredientCard(@DrawableRes resourceIcon: Int, title :String, subtitle:String, modifier: Modifier)
{
    Column(
        ...
        Card(
            ...
            Image(painter = painterResource(id = resourceIcon), contentDescription =null,
                modifier = Modifier.padding(16.dp)
            )
        }
        Text(text = title,
...
@Composable
fun CircularButton(@DrawableRes iconResource: Int, color: Color = Gray, elevation: ButtonElevation? = ButtonDefaults.elevation(), onClick: () -> Unit = {}){
    Button(onClick = onClick,
        contentPadding = PaddingValues(),
        shape = Shapes.small,
        colors = ButtonDefaults.buttonColors(backgroundColor = com.example.apprecette.ui.theme.White, contentColor = color),
        elevation = elevation,
        modifier = Modifier
            .width(38.dp)
            .height(38.dp)
...
fun TabButton(text :String, active: Boolean, modifier: Modifier){
    Button(
        ...
        colors = if(active) ButtonDefaults.buttonColors(
            ...
            contentColor = com.example.apprecette.ui.theme.White
...
fun DefaultPreview() {
    AppRecetteTheme {
        MainFragment(recipe = strawberryCake)
    }
}